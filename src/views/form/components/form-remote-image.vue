  ...
  <el-dialog title="编辑菜单" :visible="dialogFormVisible">
    <el-form :model="localFormData">
      ...
      <el-form-item label="日期" :label-width="formLabelWidth">
        <el-input v-model="localFormData.date" />
      </el-form-item>
      <el-form-item label="云量" :label-width="formLabelWidth">
        <el-input v-model="localFormData.cloud" />
      </el-form-item>
...
<script>
import { updateRemoteImage } from '@/api/api-table-remoteImage'
...
export default {
  ...
  methods: {
    ...
    clickYes() {
      ...
      updateRemoteImage(this.formData).then(response => {
        this.$message({
          message: '编辑成功',
          type: 'success'
        })
